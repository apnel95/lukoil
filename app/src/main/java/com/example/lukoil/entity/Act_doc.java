...
public class Act_doc implements Serializable {
    int id, id_department, id_department_object, id_employee, id_status;
    ...
    public Act_doc(int id, int id_employee, int id_status, Date date_time_stop) {
        this.id = id;
    ...
    public Act_doc(int id, int id_department, int id_department_object, int id_employee, int id_status, ArrayList<Event_date_time> events, ArrayList<Remark> remarks, ArrayList<Work> works, String FIO_senging) {
        this.id = id;
